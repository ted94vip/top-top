                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <p><b>Артикул: </b><?=$product->articul?> </p>
                             ...
                             <p><b>Осталось: </b> <?=$product->quantity?> </p>
                            <p><b>В наличии: </b> <?=$product->availability?> </p>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <a href="<?=\yii\helpers\Url::to(['cart/add','id'=>$hit->id])?>" data-id="<?=$product->id?>" type="button" class="btn btn-default add-to-cart clearfix"><i class="fa fa-shopping-cart"></i>Добавить в корзину</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
